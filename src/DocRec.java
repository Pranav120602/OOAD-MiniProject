...
public class DocRec extends javax.swing.JFrame {
    ...
    private void Get_Data() {
        String sql = "select DoctorID as 'Doctor ID', DoctorName as 'Doctor Name',Address,ContacNo as 'Contact No',Email as 'Email ID',Qualifications,Gender,BloodGroup as 'Blood Group',DateOfJoining as 'Joining Date' from Doctor order by DoctorID";
        try {
